    ...
    public partial class FormVatTu : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void VatTuGc_Click(object sender, EventArgs e)
        {
            if ((DataRowView)bdsVT.Current != null)
            {
                ...
                Console.WriteLine(TempData["TENVT"]);
            }
        }
        ...
        private bool CheckDataInput()
        {
            ...
            if (Regex.IsMatch(SoLgTonTb.Text, @"^[a-zA-Z0-9]+$") == false)
            {
                MessageBox.Show("Số lượng tồn chỉ chấp nhận số", "Thông báo", MessageBoxButtons.OK);
                SoLgTonTb.Focus();
                return false;
            }
            ...
            {
                MessageBox.Show("Tên vật tư không thể lớn hơn 30 kí tự", "Thông báo", MessageBoxButtons.OK);
                TenVTTb.Focus();
                return false;
            }
            ...
            {
                MessageBox.Show("Đơn vị tính không thể lớn hơn 15 kí tự", "Thông báo", MessageBoxButtons.OK);
                DvtTb.Focus();
                return false;
            }
